						...
						<div style="margin:0 auto">
							...
							<div>
								<a href="my/need/toAdd" class="btn">继续创建模块</a> <a
									...
									href="my/need" class="btn">返回我的模块我的模块</a>
							</div>
						</div>
					</div>
				</div>
...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"my/need/active?r=" + Math.random(),data:$("form").serialize(),
