					...
					<div class="modal-body">
						<div style="margin:0 auto">
							...
							<div>
								...
								<a href="my/task/detail" class="btn">任务详情</a>
							</div>
						</div>
					</div>
				</div>
...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"my/task/active?r=" + Math.random(),data:$("form").serialize() + "&comment=" + UM.getEditor('comment').getContent(),dataType:"json",success:function(data){
		if(data.code == 0){
