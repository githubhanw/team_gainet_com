...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"my/task/delay?r=" + Math.random(),data:"id=" + $("#id").val() + "&delayed_date=" + $("#delayed_date").val() + "&delayed_review_id=" + $("#delayed_review_id").val() + "&comment=" + $("#comment").val(),dataType:"json",success:function(data){
		if(data.code == 0){
