					...
					<div class="center-block">
						<div class="main-header">
							<h2>
								...
								<a href="my/task/index">${t.taskName}</a>
								<small>&nbsp;<i class="icon-angle-right"></i>&nbsp; 任务延期审核</small>
							</h2>
						</div>
...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"my/task/delayCheck?r=" + Math.random(),data:$("form").serialize() + "&comment=" + UM.getEditor('comment').getContent(),dataType:"json",success:function(data){
		if(data.code == 0){
