...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"my/task/handover?r=" + Math.random(),data:$("form").serialize() + "&handover_info=" + UM.getEditor('handover_info').getContent(),dataType:"json",success:function(data){
		if(data.code == 0){
