...
<html>
	...
	$("#submit").click(function(){
		...
		$.ajax({type:"POST",url:"my/task/relevance?r=" + Math.random(),data:"id=" + $("#id").val() + "&needs=" + ($("#needs").val() == null ? "" : $("#needs").val()) + "&comment=" + UM.getEditor('comment').getContent(),dataType:"json",success:function(data){
			if(data.code == 0){
