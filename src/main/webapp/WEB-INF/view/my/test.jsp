			...
			<div class="container">
				...
				<div id="mainMenu" class="clearfix">
					<div class="btn-toolbar pull-left">
						<a href="my/test?type=1" class="btn btn-link ${prm.type == 1 ? 'btn-active-text':''}">
							<span class="text">待测试</span>
							<c:if test="${prm.type == 1}">
								<span class="label label-light label-badge">${pageList.totalCounts}</span>
							</c:if>
						</a>
						<a href="my/test?type=5" class="btn btn-link ${prm.type == 5 ? 'btn-active-text':''}">
							<span class="text">由我提测</span>
									...
									<thead>
										<tr>
											...
											<th data-flex="false" data-width="50px" style="width:100px" class="c-pri text-center" title="类型">
												<a href="${pageList.desAction}&orderColumn=apply_type&orderByValue=${prm.orderColumn=='state'&&prm.orderByValue=='DESC'?'ASC':'DESC'}"
											...
											<th data-flex="false" data-width="50px" style="width:100px" class="c-pri text-center" title="测试人">测试人</th>
									...
									<tbody>
										...
										<tr>
											...
											<td class="c-pri text-left">
												<a href="my/test/detail?id=${apply.id}">
											...
											<td class="c-actions text-center">
												<c:if test="${apply.state > 0}">
													<a href="my/test/toEdit?id=${apply.id}" class="btn" title="编辑"><i class="icon-common-edit icon-edit"></i></a>
													<a href="my/test/toDismissal?id=${apply.id}" class="btn" title="驳回"><i class="icon icon-reply-all"></i></a>
													<a href="my/test/toReceive?id=${apply.id}" class="btn" title="领取"><i class='icon-task-start icon-play'></i></a>
