				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div style="margin: 0 auto">
							...
							<div>
								<a href="my" class="btn">返回我的地盘</a>
								<a href="my/weixin" class="btn">返回当前页</a>
							</div>
						</div>
					</div>
				</div>
...
<script>
	$(function(){
		...
		if(parma){
			//生成二维码
			var url = "http://bshare.optimix.asia/barCode?site=weixin&url=${bindUrl}";
			$("#bdwx img").attr("src",url);
			$("#bdwx").show();
			checkbind();
		}else{
			$("#unbind").show();
...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"my/unbindwx",dataType:"json",success:function(data){
		if(data.code == 0){
