								...
								<tr>
									...
									<td class="required">
										<input type="text" name="end_date" id="end_date"
												class="form-control form-date-limit" placeholder="交付日期" autocomplete="off" style="border-radius: 2px 0px 0px 2px;" readonly="readonly">
									</td>
									<td></td>
								</tr>
								<tr>
...
$("#submit").click(function(){
	...
	$.ajax({
         url:"team/need/addneed?r=" + Math.random(),
         type:"post",
         data:form,
         dataType:"json",
         processData:false,
