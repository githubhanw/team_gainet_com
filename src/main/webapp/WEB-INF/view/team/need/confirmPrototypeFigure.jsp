									   ...
									   <tr>
									     ...
									     <td>
									     	<c:if test="${sub.interface_img !=null }">
										 		<c:forEach items="${fn:split(sub.interface_img, ',')}" var="flow" varStatus="sta">
													<img src="${flow}" data-toggle="lightbox" height="50px" data-caption="【原型图】">&nbsp;&nbsp;
												</c:forEach> 
											</c:if>
											<c:if test="${sub.interface_img ==null }">
...
$("#submit").click(function(){
	...
	var form = new FormData(document.getElementById("createForm"));
		...
		$.ajax({
	         url:"team/need/confirmPrototypeFigure?r=" + Math.random(),
	         type:"post",
	         data:form,
	         dataType:"json",
	        processData:false,
...
$("#rejected").click(function(){
	...
	var form = new FormData(document.getElementById("createForm"));
		$.ajaxSettings.async = false;
		$.ajax({
	         url:"team/need/toRejected?r=" + Math.random(),
	         type:"post",
	         data:form,
	         dataType:"json",
	        processData:false,
