				...
				<div id="mainActions">
					...
					<div class="btn-toolbar">
						...
						<c:if test="${needM.state != 3}">
							<a href="team/need/toClose?id=${needM.id}" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="关闭"><i class='icon-task-close icon-off'></i> 关闭</a>
						</c:if>
						<c:if test="${needM.state == 3}">
							<a href="team/need/toActive?id=${needM.id}" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="激活">激活</a>
						</c:if>
						<c:if test="${needM.state == 1 || needM.state == 2}">
							<c:if test="needM.full == 1">
								<a href="team/need/toCheck?id=${needM.id}" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="验收"><i class="icon-story-review icon-glasses"></i> 验收</a>
						...
						<c:if test="${needM.parent_id == null || needM.parent_id == ''}">
							<a href="team/need/toRelevance?id=${needM.id}" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="关联需求"><i class='icon icon-sitemap'></i> 关联</a>
						</c:if>
						<div class="divider"></div>
						...
						<a href="javascript:void(0)" onclick="del(${needM.id})" class="btn btn-link" data-toggle="tooltip" data-placement="top" title="删除"><i class="icon-common-delete icon-trash"></i> 删除</a>
					</div>
				</div>
				<!--mainActions end-->
			</div>
