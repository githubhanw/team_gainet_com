						...
						<table class="table table-form">
							<tbody>
								...
								<tr>
									<th>计划结束日期</th>
									<td class="required">
										<input type="text" name="plan_end_date" id="plan_end_date" value="<fmt:formatDate value="${t.startDate}" pattern="yyyy-MM-dd"/>" 
...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"team/need/open?r=" + Math.random(),data:$("form").serialize() + "&comment=" + UM.getEditor('comment').getContent(),dataType:"json",success:function(data){
		if(data.code == 0){
