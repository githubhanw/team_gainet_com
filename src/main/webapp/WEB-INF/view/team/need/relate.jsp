...
<html>
					...
					<div class="center-block">
						<div class="main-header">
							<h2>
								...
								<small>&nbsp;<i class="icon-angle-right"></i>&nbsp; 关联月会议</small>
							</h2>
						</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="required">
										...
										<select data-placeholder="请选择要关联的月会议" class="form-control chosen chosen-select" name="meeting_id" id="meeting_id">
											<option value=""></option>
											<c:forEach items="${meetings}" var="m" varStatus="sta">
												<option value="${m.id}" ${n.meetingId==m.id?'selected="selected"':''}>${m.name }</option>
											</c:forEach>
										</select>
									</td>
								</tr>
	...
	$("#submit").click(function(){
		...
		$.ajax({type:"POST",url:"team/need/relate?r=" + Math.random(),data:$("form").serialize(),
