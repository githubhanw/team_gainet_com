						...
						<table class="table table-form">
							<tbody>
								...
								<tr>
									<th>指派给</th>
									<td class="required">
										<select data-placeholder="请选择指派给谁" class="form-control chosen-select" name="assigned_id" id="assigned_id">
											<option value=""></option>
...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"team/task/assign?r=" + Math.random(),data:$("form").serialize() + "&comment=" + UM.getEditor('comment').getContent(),dataType:"json",success:function(data){
		if(data.code == 0){
