					...
					<div class="center-block">
						<div class="main-header">
							<h2>
								...
								<small>&nbsp;<i class="icon-angle-right"></i>&nbsp; 暂停</small>
							</h2>
						</div>
...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"team/task/pause?r=" + Math.random(),data:$("form").serialize() + "&comment=" + UM.getEditor('comment').getContent(),dataType:"json",success:function(data){
		if(data.code == 0){
