					...
					<div class="center-block">
						<div class="main-header">
							<h2>
								...
								<a href="test/bug/index">${t.tasktype}</a>
								<small>&nbsp;<i class="icon-angle-right"></i>&nbsp; 删除BUG</small>
							</h2>
						</div>
...
$("#submit").click(function(){
	...
	$.ajax({type:"POST",url:"test/bug/delete?r=" + Math.random(),data:$("form").serialize(),
