							...
							<form class="load-indicator main-form form-ajax" id="createForm" method="post">
								...
								<tr>
								    ...
								    <td class="overflow: visible">
										<select data-placeholder="请选择项目" class="form-control chosen-select" name="taskProject_id" id="taskProject_id">
											<option value=""></option>
											<c:forEach items="${taskProjectList}" var="taskProjectList" varStatus="sta">
												<option value="${taskProjectList.id}">${taskProjectList.project_name}(${taskProjectList.id})</option>
											</c:forEach>
										</select>
									</td>
								    <td></td>
